async function about(discord, msg, mongo, commands, content, config) {
    ...
    embed.addField(`What is it?`, `\`Echelon\` is an open source Discord bot powered by [discord.js](https://discord.js.org/#/). View its source code [here!](https://github.com/waymondrang/echelon)`)
